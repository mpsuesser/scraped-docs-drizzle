---
url: https://orm.drizzle.team/docs/guides/seeding-with-partially-exposed-schema
...
```
- You can [refine](seeding-with-partially-exposed-schema.md#refining-the-userid-column-generator) the `userId` column generator;
...
- Otherwise, you can [refine](seeding-with-partially-exposed-schema.md#refining-the-userid-column-generator) the `userId` column generator.

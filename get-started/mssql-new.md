---
url: https://orm.drizzle.team/docs/get-started/mssql-new
title: "Mssql New"
description: ""
...
```shell
npm i drizzle-orm@rc mssql dotenv
...
**Drizzle config** - a configuration file that is used by [Drizzle Kit](../mssql/kit-overview.md) and contains all the information about your database connection, migration folder and schema files.
...
Read more about the push command in [documentation](../mssql/drizzle-kit-push.md).
...
Read more about migration process in [documentation](../mssql/kit-overview.md).

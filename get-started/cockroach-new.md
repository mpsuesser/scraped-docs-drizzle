---
url: https://orm.drizzle.team/docs/get-started/cockroach-new
title: "Cockroach New"
description: ""
...
We will use `node-postgres` for this get started example. But if you want to find more ways to connect to postgresql check our [CockroachDB Connection](../cockroach/get-started-cockroach.md) page
...
**Drizzle config** - a configuration file that is used by [Drizzle Kit](../cockroach/kit-overview.md) and contains all the information about your database connection, migration folder and schema files.
...
Read more about the push command in [documentation](../cockroach/drizzle-kit-push.md).
...
Read more about migration process in [documentation](../cockroach/kit-overview.md).

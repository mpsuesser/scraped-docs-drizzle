---
url: https://orm.drizzle.team/docs/get-started/planetscale-new
title: "Planetscale New"
description: ""
...
Looking for PostgreSQL? Check out our [PlanetScale Postgres guide](planetscale-postgres-new.md)

important

For this tutorial, we will use the `database-js` driver to make **HTTP** calls to the PlanetScale database. If you need to connect to PlanetScale through TCP, you can refer to our [MySQL Get Started](mysql-new.md) page
...
```shell
npm i drizzle-orm@rc @planetscale/database dotenv

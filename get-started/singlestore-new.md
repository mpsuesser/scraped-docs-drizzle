---
url: https://orm.drizzle.team/docs/get-started/singlestore-new
title: "Singlestore New"
description: ""
...
**Drizzle config** - a configuration file that is used by [Drizzle Kit](../singlestore/kit-overview.md) and contains all the information about your database connection, migration folder and schema files.
...
Read more about the push command in [documentation](../singlestore/drizzle-kit-push.md).
...
Read more about migration process in [documentation](../singlestore/kit-overview.md).

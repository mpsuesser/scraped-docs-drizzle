---
url: https://orm.drizzle.team/docs/get-started/singlestore-existing
title: "Singlestore Existing"
description: ""
...
The result of introspection will be a `schema.ts` file, `meta` folder with snapshots of your database schema, sql file with the migration and `relations.ts` file for [relational queries](../singlestore/rqb-v2.md).
...
Learn more about introspection in the [documentation](../singlestore/drizzle-kit-pull.md).

---
url: https://orm.drizzle.team/docs/get-started/planetscale-existing
title: "Planetscale Existing"
description: ""
...
Looking for PostgreSQL? Check out our [PlanetScale Postgres guide](planetscale-postgres-existing.md)
...
The result of introspection will be a `schema.ts` file, `meta` folder with snapshots of your database schema, sql file with the migration and `relations.ts` file for [relational queries](../mysql/rqb.md).
...
Learn more about introspection in the [documentation](../mysql/drizzle-kit-pull.md).

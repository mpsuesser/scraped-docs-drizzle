---
url: https://orm.drizzle.team/docs/get-started/mssql-existing
title: "Mssql Existing"
description: ""
...
The result of introspection will be a `schema.ts` file, `meta` folder with snapshots of your database schema, sql file with the migration and `relations.ts` file for [relational queries](../mssql/rqb.md).
...
Learn more about introspection in the [documentation](../mssql/drizzle-kit-pull.md).

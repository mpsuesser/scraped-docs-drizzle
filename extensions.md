---
url: https://orm.drizzle.team/docs/extensions
title: "Extensions"
description: ""
...
For more info please refer to the official pg\_vector **[docs.](https://github.com/pgvector/pgvector)**
...
If you are using the `introspect` or `push` commands with the PostGIS extension and don’t want PostGIS tables to be included, you can use [extensionsFilters](drizzle-config-file.md#extensionsfilters) to ignore all the PostGIS tables

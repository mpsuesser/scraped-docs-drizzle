---
url: https://orm.drizzle.team/docs/cockroach/drizzle-kit-pull
...
npx drizzle-kit pull --dialect=cockroach --driver=pglite url=database/
npx drizzle-kit pull --dialect=cockroach --tablesFilter=‘user*’ url=postgresql://user:password@host:port/dbname
```

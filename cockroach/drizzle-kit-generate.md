---
url: https://orm.drizzle.team/docs/cockroach/drizzle-kit-generate
...
Example of how to create a custom cockroach migration file named `0001_seed-users.sql` with Drizzle schema located in `./src/schema.ts` and migrations folder named `./migrations` instead of default `./drizzle`.

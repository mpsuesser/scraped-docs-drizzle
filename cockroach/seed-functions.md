---
url: https://orm.drizzle.team/docs/cockroach/seed-functions
...
Currently, if you set arraySize to a value greater than 1 or try to insert more than one `geometry point` element into a `geometry(point, 0)[]` column in CockroachDB or CockroachDB via drizzle-orm, you’ll encounter an error.

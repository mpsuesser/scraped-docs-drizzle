---
url: https://orm.drizzle.team/docs/mssql/sql
title: "Sql"
description: ""
...
Additionally, any dynamic parameters such as `${id}` will be mapped to the @par0 placeholder, and the corresponding values will be moved to an array of values that are passed separately to the database.

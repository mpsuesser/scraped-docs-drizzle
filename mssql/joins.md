---
url: https://orm.drizzle.team/docs/mssql/joins
title: "Joins"
description: ""
...
Drizzle ORM has APIs for `INNER JOIN`, `LEFT JOIN`, `RIGHT JOIN`, and `FULL JOIN`. Lets have a quick look at examples based on below table schemas:

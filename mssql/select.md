---
url: https://orm.drizzle.team/docs/mssql/select
title: "Select"
description: ""
...
As an alternative to `cast(... as int)`, you can use [`.mapWith(Number)`](sql.md#sqlmapwith) to cast the value to a number at runtime.

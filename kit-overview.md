...
Make sure to first go through Drizzle [get started](get-started.md) and [migration fundamentals](migrations.md) and pick SQL migration flow that suits your business needs best.

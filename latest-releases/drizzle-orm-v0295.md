---
url: https://orm.drizzle.team/docs/latest-releases/drizzle-orm-v0295
title: "Drizzle Orm V0295"
description: ""
...
You can now use `WITH` statements with [INSERT](../insert.md#with-insert-clause), [UPDATE](../update.md#with-update-clause) and [DELETE](../delete.md#with-delete-clause) statements
...
- [with insert docs](../insert.md#with-insert-clause)
- [with update docs](../update.md#with-update-clause)
- [with delete docs](../delete.md#with-delete-clause)
...
You can find more information about SQLite proxy in [docs](../sqlite/get-started-sqlite.md#http-proxy).

- You can now use `.query.findFirst` and `.query.findMany` syntax with sqlite proxy driver
- SQLite Proxy supports batch requests, the same as it’s done for all other drivers. Check full [docs](../batch-api.md)

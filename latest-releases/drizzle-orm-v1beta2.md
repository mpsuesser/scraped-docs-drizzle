...
> Check new RQBv2 schema docs: [https://orm.drizzle.team/docs/relations](https://orm.drizzle.team/docs/relations)

> Check new RQBv2 query docs: [https://orm.drizzle.team/docs/rqb](https://orm.drizzle.team/docs/rqb)
...
- [blob](../mysql/column-types.md#blob)
- [tinyblob](../mysql/column-types.md#tinyblob)
- [mediumblob](../mysql/column-types.md#mediumblob)
- [longblob](../mysql/column-types.md#longblob)

---
url: https://orm.drizzle.team/docs/latest-releases/drizzle-orm-v0290
title: "Drizzle Orm V0290"
description: ""
...
Read more in [docs](../mysql/column-types.md#bigint)
...
Read more in [docs](../dynamic-query-building.md)
...
Read more in [docs](../indexes-constraints.md#composite-primary-key)
...
Read more in [docs](../read-replicas.md)
...
Read more in [docs](../set-operations.md)
...
Read more in [docs](../mysql/get-started-mysql.md#http-proxy)
...
Read more in [docs](../get-started-postgresql.md#http-proxy)
...
More usage examples here: [integration-tests/tests/d1-batch.test.ts](https://github.com/drizzle-team/drizzle-orm/blob/beta/integration-tests/tests/d1-batch.test.ts) and in [docs](../batch-api.md)

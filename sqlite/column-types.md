---
url: https://orm.drizzle.team/docs/sqlite/column-types
title: "Column Types"
description: ""
...
You can use database aliases in column names if you want, and you can also use the `casing API` to define a mapping strategy for Drizzle. You can read more about it [here](sql-schema-declaration.md#shape-your-data-schema)

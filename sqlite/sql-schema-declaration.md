---
url: https://orm.drizzle.team/docs/sqlite/sql-schema-declaration
...
This example uses a db object, whose initialization is not covered in this part of the documentation. To learn how to connect to the database, please refer to the [Connections Docs](get-started-sqlite.md)

---
url: https://orm.drizzle.team/docs/sqlite/connect-expo-sqlite
title: "Connect Expo Sqlite"
description: ""
...
- [Drizzle Kit](kit-overview.md) support for migration generation and bundling in application ✅
- [Drizzle Studio](https://github.com/drizzle-team/drizzle-studio-expo) dev tools plugin to browse on device database ✅
- Live Queries ✅

```shell
npm i drizzle-orm@rc expo-sqlite@next
...
Please make sure to check how [Drizzle migrations](kit-overview.md) work before proceeding.  

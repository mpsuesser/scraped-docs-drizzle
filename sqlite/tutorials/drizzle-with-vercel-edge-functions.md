---
url: https://orm.drizzle.team/docs/sqlite/tutorials/drizzle-with-vercel-edge-functions
...
- [libSQL client](../get-started-sqlite.md#turso) allows you to access [Turso](https://docs.turso.tech/introduction) database.
...
You can check [quickstart guide](../get-started-sqlite.md#turso) or [tutorial](../../tutorials/drizzle-with-turso.md) for Drizzle with Turso in the documentation.

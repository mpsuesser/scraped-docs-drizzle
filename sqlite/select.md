---
url: https://orm.drizzle.team/docs/sqlite/select
title: "Select"
description: ""
...
`cast(... as int)` keeps the selected count value typed as a number. Alternatively, you can use [`.mapWith(Number)`](sql.md#sqlmapwith) to cast the value to a number at runtime.

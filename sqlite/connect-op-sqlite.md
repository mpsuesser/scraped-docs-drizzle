---
url: https://orm.drizzle.team/docs/sqlite/connect-op-sqlite
title: "Connect Op Sqlite"
description: ""
...
```shell
npm i drizzle-orm@rc @op-engineering/op-sqlite
...
Please make sure to check how [Drizzle Kit migrations](kit-overview.md) work before proceeding.  

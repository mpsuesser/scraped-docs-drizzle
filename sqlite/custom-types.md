---
url: https://orm.drizzle.team/docs/sqlite/custom-types
title: "Custom Types"
description: ""
...
export interface CustomTypeParams<T extends CustomTypeValues> {
     ...
     * @example
     * For example, when querying blob column via [RQB](../rqb.md) or [JSON functions](https://orm.drizzle.team/docs/json-functions), the result field will be returned as it's hex string representation, as opposed to Buffer from regular query

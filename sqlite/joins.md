---
url: https://orm.drizzle.team/docs/sqlite/joins
title: "Joins"
description: ""
...
Drizzle ORM has APIs for `INNER JOIN`, `LEFT JOIN`, `RIGHT JOIN`, `FULL JOIN`, and `CROSS JOIN`. Lets have a quick look at examples based on below table schemas:

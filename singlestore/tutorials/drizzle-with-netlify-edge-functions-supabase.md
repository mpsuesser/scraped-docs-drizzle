---
url: https://orm.drizzle.team/docs/singlestore/tutorials/drizzle-with-netlify-edge-functions-supabase
...
Alternatively, you can use migrations workflow. Read about it here: [Migrations](../../migrations.md).

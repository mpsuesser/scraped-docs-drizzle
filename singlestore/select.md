---
url: https://orm.drizzle.team/docs/singlestore/select
title: "Select"
description: ""
...
`cast(... as int)` is necessary because `count()` returns `decimal` in SingleStore, which is treated as a string value instead of a number. Alternatively, you can use [`.mapWith(Number)`](sql.md#sqlmapwith) to cast the value to a number at runtime.

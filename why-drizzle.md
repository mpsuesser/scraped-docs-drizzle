...
Drizzle operates natively through industry-standard database drivers. We support all major **[PostgreSQL](get-started-postgresql.md)**, **[MySQL](mysql/get-started-mysql.md)** or **[SQLite](sqlite/get-started-sqlite.md)** drivers out there, and we’re adding new ones **[really fast](https://twitter.com/DrizzleORM/status/1653082492742647811?s=20)**.
...
Now go build something awesome with Drizzle and your **[PostgreSQL](get-started-postgresql.md)**, **[MySQL](mysql/get-started-mysql.md)** or **[SQLite](sqlite/get-started-sqlite.md)** database. 🚀

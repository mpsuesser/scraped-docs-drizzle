...
Now go build something awesome with Drizzle and your **[PostgreSQL](get-started-postgresql.md)**, **[MySQL](mysql/get-started-mysql.md)**, **[SQLite](sqlite/get-started-sqlite.md)**, **[MSSQL](mssql/get-started-mssql.md)** or **[CockroachDB](cockroach/get-started-cockroach.md)** database. 🚀

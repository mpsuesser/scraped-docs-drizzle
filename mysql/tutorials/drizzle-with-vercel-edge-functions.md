---
url: https://orm.drizzle.team/docs/mysql/tutorials/drizzle-with-vercel-edge-functions
...
- [PlanetScale serverless driver](../get-started-mysql.md#planetscale) allows you access any `MySQL` client and execute queries over an HTTP connection, which is generally not blocked by cloud providers.

---
url: https://orm.drizzle.team/docs/mysql/drizzle-kit-push
...
`drizzle-kit push` will manage all MySQL tables by default. You can configure the list of tables via `tablesFilter`.
...
npx drizzle-kit push dialect=mysql schema=src/schema.ts --tablesFilter=‘user*’ url=mysql://user:password@host:3306/dbname
```

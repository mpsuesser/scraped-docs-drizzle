---
url: https://orm.drizzle.team/docs/mysql/kit-overview
title: "Kit Overview"
description: ""
...
Make sure to first go through Drizzle [get started](https://orm.drizzle.team/docs/mysql/get-started) and [migration fundamentals](migrations.md) and pick SQL migration flow that suits your business needs best.
...
| [`drizzle-kit export`](drizzle-kit-export.md) | used converting TS schema into raw SQL DDL and print it out [see here](drizzle-kit-export.md) |

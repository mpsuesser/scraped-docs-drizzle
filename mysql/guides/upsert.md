---
url: https://orm.drizzle.team/docs/mysql/guides/upsert
title: "Upsert"
description: ""
...
- Get started with [PostgreSQL](../../get-started-postgresql.md), [MySQL](../get-started-mysql.md), [SQLite](../../sqlite/get-started-sqlite.md), [MSSQL](../../mssql/get-started-mssql.md) and [Cockroach](../../cockroach/get-started-cockroach.md)
- [Insert statement](../../insert.md), [onConflictDoUpdate method](../../insert.md#on-conflict-do-update) and [onDuplicateKeyUpdate method](../insert.md#on-duplicate-key-update)
- [Composite primary key](../../indexes-constraints.md#composite-primary-key)
- [sql operator](../../sql.md)
...
To implement an upsert query in PostgreSQL, Cockroach and SQLite (skip to [MySQL](../../guides/upsert.md#mysql)) with Drizzle you can use `.onConflictDoUpdate()` method:
